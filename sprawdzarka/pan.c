...
/*** From source: C:\PRI-sprawdzarka\sprawdzarka\task\promela\student_files\np02b_CeDG6Xi.pml ***/
...
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "C:\\PRI-sprawdzarka\\sprawdzarka\\task\\promela\\student_files\\np02b_CeDG6Xi.pml", 1, 12 },
	{ "-", 13, 14 }
};
uchar reached0 [] = {
	  0,   0,   1,   1,   1,   0,   0,   0, 
