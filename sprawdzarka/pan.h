...
#define _nstates4	14	/* L4 */
#define minseq4	51
#define maxseq4	63
#define _endstate4	13

#define _nstates3	14	/* L3 */
#define minseq3	38
#define maxseq3	50
#define _endstate3	13

#define _nstates2	14	/* L2 */
#define minseq2	25
#define maxseq2	37
#define _endstate2	13

#define _nstates1	14	/* L1 */
#define minseq1	12
#define maxseq1	24
...
#define Air0	(sizeof(P0) - Offsetof(P0, i) - 1*sizeof(uchar))
...
typedef struct P6 {
	...
	unsigned _p   : 5; /* active-claim state */
