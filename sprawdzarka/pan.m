...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* CLAIM L4 */
	case 3: // STATE 1 - _spin_nvr.tmp:36 - [((a==1))] (0:0:0 - 1)
		...
		if (!((((int)now.a)==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 4: // STATE 8 - _spin_nvr.tmp:41 - [((a==1))] (0:0:0 - 1)
		...
		if (!((((int)now.a)==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 5: // STATE 13 - _spin_nvr.tmp:43 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* CLAIM L3 */
	case 6: // STATE 1 - _spin_nvr.tmp:25 - [((a==2))] (0:0:0 - 1)
		...
		if (!((((int)now.a)==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 7: // STATE 8 - _spin_nvr.tmp:30 - [((a==2))] (0:0:0 - 1)
	...
	case 8: // STATE 13 - _spin_nvr.tmp:32 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* CLAIM L2 */
	case 9: // STATE 1 - _spin_nvr.tmp:14 - [((a==3))] (0:0:0 - 1)
		...
		if (!((((int)now.a)==3)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 10: // STATE 8 - _spin_nvr.tmp:19 - [((a==3))] (0:0:0 - 1)
		...
		if (!((((int)now.a)==3)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 11: // STATE 13 - _spin_nvr.tmp:21 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* CLAIM L1 */
	case 12: // STATE 1 - _spin_nvr.tmp:3 - [(!((a==9)))] (0:0:0 - 1)
